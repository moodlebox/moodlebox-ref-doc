...
\title{MoodleBox building reference\\Version 4.10.0%
...
The present work is licensed under a \href{http://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons Attribution - Non Commercial - Share Alike  4.0 International} license.

The \href{https://github.com/moodlebox/moodlebox}{MoodleBox source code} is licensed under a \href{https://www.gnu.org/licenses/agpl-3.0.en.html}{GNU Affero General Public License v3.0}.

The \href{https://github.com/moodlebox/moodle-tool_moodlebox}{MoodleBox plugin for Moodle source code} is licensed under a \href{https://www.gnu.org/licenses/gpl-3.0.en.html}{GNU General Public License v3.0}.
...
USB tethering is supported out of the box, except for iOS devices.
Installing \lstinline{usbmuxd} enables tethering for such devices.
\begin{lstlisting}[language=bash]
