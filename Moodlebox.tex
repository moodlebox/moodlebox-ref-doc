...
\title{MoodleBox building reference\\Version 4.9.0%
...
\item AdminNeo, a full-featured database management tool, is installed (\url{http://moodlebox.home/adminer.php}).
\end{itemize}
...
\section{Installation of \textsl{AdminNeo}}

\textsl{AdminNeo}, successor of Adminer, is a full-featured database management tool written in PHP.
...
\begin{lstlisting}[language=bash]
$ sudo wget -c https://github.com/adminneo-org/adminneo/releases/download/v4.17.2/adminer-4.17.2.php -O /var/www/moodle/adminer.php
